...
Listing* Create::createListing(CarDealership& dealership, const std::string& username) {
    int type, quantity, year, miles;
    string name, make, model, condition;
    double buyItNow, bid;
    ...
    if (type == 1) {
        ...
        return new Part(name, buyItNow, bid, username, quantity); // Use the provided username
    } else {
        ...
        return new Vehicle(name, buyItNow, bid, username, make, model, year, miles, condition); // Use the provided username
    }
}